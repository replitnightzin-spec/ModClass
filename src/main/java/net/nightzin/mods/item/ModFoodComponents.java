...
public class ModFoodComponents {
    ...
    public static final FoodComponent MACONHA = new FoodComponent.Builder().nutrition(1).saturationModifier(0.25f)
            .statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 200),100).build();
}
